    ...
    <div className="font-sans">
      ...
      <header className="bg-yellow-100 shadow">
        <nav className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-heading text-yellow-900">The Golden Ratio Bakery</h1>
      ...
      {/* Hero Section */}
      <section className="relative text-center bg-pink-100">
        <img
          src="/cake.jpg"
          alt="Delicious Cake"
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 text-white">
          <h2
            className="text-5xl font-heading drop-shadow-lg glow"
            data-aos="zoom-in"
          >
            Freshly Baked. Purely Delicious.
          </h2>
          <p className="mt-3 font-body">Warm up your day with our handmade delights.</p>
          <a
            href="#menu"
      ...
      <section id="menu" className="py-12 bg-white text-center">
        <h2 className="text-3xl font-heading mb-8 text-yellow-800">Our Menu</h2>
        <div className="grid md:grid-cols-3 gap-6 px-8">
          {[
            ...
            <div key={i} className="bg-yellow-50 shadow-md rounded-lg p-4" data-aos="fade-up">
      ...
      <section id="about" className="py-10 bg-yellow-100 text-center">
        <h2 className="text-3xl font-heading text-yellow-900 mb-4">About Us</h2>
        <p className="max-w-2xl mx-auto text-gray-700 px-4 font-body">
      ...
      <section id="contact" className="py-10 bg-white text-center">
        <h2 className="text-3xl font-heading text-yellow-900 mb-4">Contact</h2>
      ...
      <section id="owner" className="py-10 bg-yellow-100 text-center">
        <h2 className="text-3xl font-heading text-yellow-900 mb-4">Meet the Owner</h2>
