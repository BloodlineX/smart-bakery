      ...
      <section id="menu" className="py-12 bg-white text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 px-8">
          {[
            ...
            { src: `${process.env.PUBLIC_URL}/donuts.jpg`, title: "Donuts", desc: "Glazed, sprinkled, and filled — melt-in-mouth magic!" },
            { src: `${process.env.PUBLIC_URL}/muffins.jpg`, title: "Muffins", desc: "Blueberry, banana, choco-chip & more moist bites!" },
            { src: `${process.env.PUBLIC_URL}/croissant.jpg`, title: "Croissants", desc: "Flaky, buttery French pastry for your morning mood." }
          ].map((item, i) => (
            <div key={i} className="bg-yellow-50 shadow-md rounded-lg p-4" data-aos="zoom-in">
              <img src={item.src} alt={item.title} className="w-full h-[240px] object-cover rounded" />
      ...
      <section id="order" className="py-12 bg-pink-50">
        <div className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-lg" data-aos="fade-up">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input type="text" name="item" placeholder="What would you like? (e.g., Donuts)" required value={formData.item} onChange={handleChange} className="w-full border p-2 rounded" />
