...
const addToCart = (item) => { setCart([...cart, item]); setFormData({ ...formData, item }); window.location.hash = "order"; };
...
{/* Hero Section */}
  <section className="relative text-center py-10 bg-pink-100">
    <img src="/cake.jpg" alt="Delicious Cake" className="w-full h-[300px] md:h-[600px] object-cover opacity-80" />
  ...
  <section className="py-10 bg-yellow-50 text-center">
    <h2 className="text-2xl font-heading text-yellow-900 mb-4">🛒 Your Cart</h2>
    {cart.length > 0 ? (
